...
The purpose of program "Kasino" is to quess ten numbers in range of 0-10.
...
TEST1: miminum (50) added > minimum (50) bet = OKAY
TEST2: sazka <50 = OKAY
TEST3: sazka > hotovost = OKAY

*** přepis zdrojového kódu Pascal > Python...
*** zdrojový kód má: 129 řádků (bez poznámek)

"""
# zpomalit vypisování jednotlivých hlášek (import.time - sleep 2)
# TIP: obtížnost moc vysoká -> 10 čísel v intervalu 0-2 = zvýšení šance na výhru
...
while True:  
    ...
    for i in range(10):
        draw = draws.append(random.randint(0,11))
    for i in range(1,11):
...
# Otestovat všechny možnosti
# Otestovat viz. Pascal ZK
